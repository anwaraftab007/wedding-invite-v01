<?php
    ...
    if(isset($_SESSION['key'])) {
      $blog_id = substr($_SERVER['REQUEST_URI'], 17);

      $sql = mysqli_query($con, "SELECT * FROM blog WHERE id = '$blog_id'");
      $row = mysqli_fetch_assoc($sql);

      if($blog_id && mysqli_num_rows($sql) != 0) {
        if(isset($_POST['blog_title'])) {
            ...
            $blog_content = urldecode($_POST['blog_content']);
    ...
    <?php
                ...
                if (move_uploaded_file($_FILES["blog_image"]["tmp_name"], $target_dir . $newfilename)) {
                    ...
                    //   "INSERT INTO blog(blog_title,blog_categories,author_name,blog_image,blog_date,meta_title,meta_keywords,meta_description,blog_content)
                    ...
                    if($sqlEdit) {
                      header("Location:../blog-successful/");
                      die();
                    } else {
                      header("Location:../blog-unsuccessful/");
                      die();
                    }
                } else {
    ?>
    ...
    <body>
                          ...
                          <div class="row">
                            <div class="col-lg-12 form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" name="blog_title" class="form-control" value="<?php echo $row['blog_title']; ?>" required />
                              </div>
                            </div>
                            <div class="col-lg-12 form-group">
                            ...
                            <input type="hidden" name="blog_categories" class="blog-categories" value="<?php echo $row['blog_categories']; ?>" />
                            <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-12 form-group">
                              ...
                              <input type="text" class="blog-date" value="<?php echo $row['blog_date']; ?>" />
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12 form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" name="meta_title" class="form-control" value="<?php echo $row['meta_title']; ?>" required />
                              </div>
                            </div>
                            <div class="col-lg-12 form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" name="meta_keywords" class="form-control" value="<?php echo $row['meta_keywords']; ?>" required />
                              </div>
                            </div>
                            <div class="col-lg-12 form-group">
                              <label>Meta Description*</label>
                              <textarea name="meta_description" class="form-control" required><?php echo $row['meta_description']; ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-12">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <div class="row">
                            <div class="col-lg-12">
                              <textarea name="blog_content" class="summernote"><?php echo $row['blog_content']; ?></textarea>
                            </div>
      ...
      <script>
        $(document).ready(function() {
          ...
          const tags = $(".blog-categories").val();
          ...
          for(let i = 0; i < tagsArray.length; i++) {
            ...
            object.id = tagsArray[i];
            object.text = tagsArray[i];
    
            tagsValue.push(object);
          }
          
          $("select.select2").val(tagsArray);
