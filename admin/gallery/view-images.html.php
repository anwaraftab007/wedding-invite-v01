...
if (isset($_SESSION['key'])) {
    ...
    if (isset($_GET['action'])) {
        if ($_GET['action'] == "delete") {
            ...
            $galleryImage = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM gallery WHERE id='$id'"));
            $sqlDelete = mysqli_query($con, "DELETE FROM gallery WHERE id = '$id'");

            $target_dir = "../assets/images/gallery/" . $galleryImage['image'];

            if ($sqlDelete && unlink($target_dir)) {
                header("Location:../view-images/?delete=success");
                die();
            } else {
                header("Location:../view-images/?delete=fail");
                die();
            }
        }
    }
            ...
            <section class="section">
              <div class="section-body">
                <div class="mb-3 text-right">
                  <a href="../add-image/" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add Image</a>
                </div>
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                  <td><?php echo $i++; ?></td>
                                  <td>
                                    <img alt="image" src="../../assets/images/gallery/<?php echo $row['image']; ?>" width="100" />
                                  </td>
