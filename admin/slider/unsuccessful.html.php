...
<head>
  ...
  <title>Slider Upload Unsuccessful</title>
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
            <div class="card card-danger">
              ...
              <div class="card-body text-center">
                <img src="../../assets/images/unsuccessful.png" width="300" alt="Slider Unsuccessful" />
                <h4 class="my-4">Failed Uploading Slider!</h4>
